...
if command == "Y" or command == "Y":
    ...
    print("Restart the game dipshit")
    game = off
...
while game == on:
    ...
    while location == "lakefront":
        ...
        print("To the EAST is a wandering merchant's camp, be careful around him as he may not be trusty")
        print("What would you like to do?")
        command = input("")
        if command == "E" or command == "e":
            print("You walk EAST to the merchant's camp and sit down around the campfire.")
            location = "Merchant's Hut"
        elif command == "N" or command == "n":
            print("You walk NORTH to the cave, it's eeriness sends chills down your spine")
            location = "Cave"
    while location == "Merchant's Hut":
        stars()
        stars()
        ...
        if command == "T" or command == "t":
            if "axe" not in items and "log" in items:
